export const slideGroups = [
  ...
  },
  {
    ...
    overview: {
      eyebrow: "Chapter 11",
      headline: "Crypto security usually breaks in three places: protocol logic, infrastructure layers, or the operator's own environment.",
      intro:
        "This chapter keeps the security story simple. Funds can be lost because contract logic has bugs, because front ends or oracle infrastructure are compromised, or because the person signing from a hot wallet is using an unsafe device or workflow.",
      pillars: [
        {
          title: "Protocol and contract risk",
          bullets: [
            "Smart-contract logic can contain bugs",
            "Audits and bug bounties help find problems early",
            "One code flaw can put large pools of value at risk",
          ],
        },
        {
          title: "Infrastructure and interface risk",
          bullets: [
            "DNS, front ends, and oracle systems can be attacked",
            "Users may sign a malicious action even when the contract is fine",
            "The weak point may be the interface, not the chain itself",
          ],
        },
        {
          title: "Operator and device risk",
          bullets: [
            "Malware or an exposed hot wallet can empty accounts quickly",
            "Unsafe laptops and phones put private keys and signers at risk",
            "Good OpSec reduces the chance that one compromise ruins everything",
          ],
        },
      ],
      callout: "OPSEC is not paranoia. It is the routine practice of making theft, coercion, and mistakes harder.",
      footer: "From contract bugs and compromised interfaces to device hygiene and safer signer practice",
    },
    childContent: [
      {
        number: "11.1",
        ...
        headline: "One big side of crypto security is technical and infrastructure risk: buggy contracts, compromised interfaces, and bad external data.",
        description:
          "This slide focuses on the non-user-side attack vectors: contract logic bugs, hacked front ends or DNS, and critical dependencies like oracles. The standard defenses are review, audits, monitoring, and bug bounties.",
        frameLabel: "Three attack surfaces to watch for",
        segments: [
          {
            label: "Smart contracts",
            title: "Contract logic bugs can put funds at risk even when users behave correctly",
            bullets: [
              "A bug in protocol logic can freeze, leak, or misroute funds",
              "The bigger the protocol, the larger the blast radius",
              "Audits and code review reduce risk but do not remove it",
            ],
          },
          {
            label: "Front end and DNS",
            title: "A safe contract can still be reached through a compromised interface",
            bullets: [
              "Attackers can hack a website front end or DNS entry",
              "Phishing can also start before the site loads, for example through search ads pointing to a fake domain",
              "The user may see a fake prompt or wrong destination",
              "This can turn a normal signature into a dangerous one",
            ],
          },
          {
            label: "Oracles and disclosure",
            title: "External data and white-hat reporting both matter",
            bullets: [
              "If an oracle is manipulated, contract behavior can break badly",
              "Bug bounties give white-hat hackers a safe path to report issues",
              "The goal is to reward disclosure before an attacker exploits the flaw",
            ],
          },
        ],
        notes: [
          "A lot of security work is about finding bugs before an attacker does.",
          "Auditors, internal review, and bug bounties are all part of that defense.",
          "The next slide shifts from protocol risk to operator OpSec and device hygiene.",
        ],
      },
      {
        number: "11.2",
        ...
        headline: "The other big side of security is OpSec: if your device or private key is exposed, the wallet and the contracts it controls are no longer safe.",
        description:
          "This slide is about operator discipline. Dedicated devices, virtual machines, strong mobile hygiene, and separate signer environments matter because once an attacker has key access, they can usually move funds or abuse admin permissions immediately.",
        frameLabel: "Three practical OpSec habits",
        segments: [
          {
            label: "Dedicated environments",
            title: "Use separate machines for high-value signers and multisigs",
            bullets: [
              "A treasury or multisig signer should not live on your everyday laptop",
              "For large values, use a dedicated computer only for that signer flow",
              "The goal is to reduce exposure to random downloads, browsing, and malware",
            ],
          },
          {
            label: "Sandbox risky work",
            title: "Use virtual machines and separation for development or testing",
            bullets: [
              "Run risky links, tests, and experiments in a VM when possible",
              "On Mac, tools like Parallels can help; on Windows, VirtualBox is a common option",
              "Sandboxing reduces the chance that one bad interaction reaches your main signer setup",
            ],
          },
          {
            label: "Harden the device",
            title: "Protect phones, laptops, and hot wallets like they are part of the key",
            bullets: [
              "Keep systems updated and use strong login protections or passkeys",
              "Use reputable endpoint security tools where appropriate",
              "If the device is compromised, the wallet on it is effectively compromised too",
            ],
          },
        ],
        notes: [
          "For high-value DeFi or core-team signers, the device itself is part of the security model.",
          "Multisigs reduce key risk, but each signer still needs strong OpSec.",
          "If someone gets the private key, they can usually move funds and misuse the admin powers attached to that key.",
        ],
      },
    ],
  },
